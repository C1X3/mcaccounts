...
const features = [
  {
    ...
    description: "Accounts delivered instantly upon purchase — no waiting.",
  },
  {
    icon: (
  ...
  },
  {
    ...
    title: "Rare Accounts",
    description: "Minecraft's rarest accounts at affordable prices.",
  },
];
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-[color-mix(in_srgb,var(--foreground),#888_40%)] text-center max-w-6xl mx-auto">
            MC Accounts is the{" "}
            <span className="text-[var(--primary)] font-semibold">#1 online Minecraft account shop</span>.
            We verify that our accounts are 100% legitimate before sending them to our customers and strive to achieve customer satisfaction. 
            We attend the Minecraft Experience event in person to get our accounts and don't sell any second-hand accounts. Founded in December, 
            2024, MC Accounts was established in response to a widespread problem in the account market, aiming to provide a safe environment for users to 
            purchase their account from. On top of achieving 300+ vouches, we have received many endorsements from the following YouTubers, JudeLow, 
            ...
            for certain we are a legitimate source to obtain your Minecraft account from. You can find our full list of vouches, partners, and videos we've sponsored below.
          </p>
        </motion.div>
